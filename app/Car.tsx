...
export default function RevenueGearLanding() {
  ...
  className="text-2xl sm:text-3xl lg:text-3xl font-bold text-gray-900 mb-8 md:mb-10 leading-tight max-w-4xl mx-auto top-5"
>
  <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-500 to-orange-500 top-5">
